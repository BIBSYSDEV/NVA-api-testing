...
Background:
  ...
  * def payload = read('classpath:test_files/masterdata/project_post_body.json')
  * def getResponse = read('classpath:test_files/masterdata/project_get_result.json')
  * set getResponse.id = 'https://' + path + '/v1/projects/435486'
  * def postResponse = read('classpath:test_files/masterdata/project_post_result.json')
